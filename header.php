  ...
  <html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-primary" id="mainNav">
        <div class="container">
          <a class="navbar-brand js-scroll-trigger" href="https://www.germanna.edu"><img src="https://www.germanna.edu/wp-content/uploads/germanna-logo-white.svg" alt="gcc logo" width="264" height="80"><span class="d-none">Germanna Community College</span></a>
        </div>
      </nav>
