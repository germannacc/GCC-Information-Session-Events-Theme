...
<section class="content-section py-5">
  ...
  <div class="my-5 mb-4 bg-white pt-3 rounded" data-aos="fade-down">
    ...
    <h1 class="w-100 mb-4"><?php echo post_type_archive_title(); ?></h1>

      <div class="w-100">
    
        <?php the_field( 'campus_tour_description_text', 'options' ); ?>

      </div>

      <div class="w-100">

        <?php the_field( 'campus_tour_description_text_2', 'options' ); ?>
